  ...
  useEffect(() => {
    if (!hospitalId) {
      ...
      const fetchData = async () => {
        try {
          const response = await fetch(databaseUrls.hospitals.fromId.replace('_id', hospitalId));
    ...
    <div className="user-page">
      ...
      <div className="user-info">
        ...
        <p><strong>Departments:</strong>{' '}
          {Array.isArray(userData.departments) ? userData.departments.join(', ') : 'N/A'}
        </p>
        <p><strong>Available Services:</strong>{' '}
          {Array.isArray(userData.availableServices) ? userData.availableServices.join(', ') : 'N/A'}
        </p>
