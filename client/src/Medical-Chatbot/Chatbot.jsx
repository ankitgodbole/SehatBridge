...
const Chatbot = ({ isOpen, setIsOpen }) => {
  ...
  const API_KEY = 'AIzaSyDMsSkxbfkENQlFf-6I69TnSHuSr_uXELk';
            ...
            >
              ...
              <div
                className={`p-3 rounded-lg ${message.type === 'outgoing'
                  ...
                  : `${dark === 'dark' ? 'bg-gray-800 text-gray-200' : 'bg-gray-200 text-gray-800'}`} max-w-[80%]`}
              >
                {message.text}
              </div>
            </div>
        ...
        <div className={`p-4 border-t ${dark === "dark" ? "border-t-gray-700" : ""}`}>
          <div className="flex items-center gap-2">
            <textarea
              ...
              className={`flex-grow p-2 border rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${dark === "dark" ? "bg-gray-800 text-gray-200" : "text-gray-800"} overflow-hidden resize-none`}
              rows={1}
            />
            <button
              onClick={handleChat}
